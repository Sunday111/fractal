...
void OpenGl::SetUniform(uint32_t location, const Eigen::Matrix4f& m, bool transpose) noexcept
{
    glUniformMatrix4fv(static_cast<GLint>(location), 1, CastBool(transpose), m.data());
}

void OpenGl::SetUniform(uint32_t location, const Eigen::Matrix3f& m, bool transpose) noexcept
{
...
void OpenGl::SetUniform(uint32_t location, const Eigen::Vector4f& v) noexcept
{
    glUniform4f(static_cast<GLint>(location), v.x(), v.y(), v.z(), v.w());
}

void OpenGl::SetUniform(uint32_t location, const Eigen::Vector3f& v) noexcept
{
    glUniform3f(static_cast<GLint>(location), v.x(), v.y(), v.z());
}

void OpenGl::SetUniform(uint32_t location, const Eigen::Vector2f& v) noexcept
{
...
{
    SetTextureParameter2d(GL_TEXTURE_BORDER_COLOR, reinterpret_cast<const float*>(&v));
}
